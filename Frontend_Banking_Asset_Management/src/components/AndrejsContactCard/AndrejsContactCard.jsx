...
function AndrejsContactCard() {
  return (
    <div className="cardAndrejs">
      <img
        className="image-andrejs"
        src={cardAndrejs1}
        alt="contact person image"
      />
      <div className="aboutus-card-texts-links-andrejs">
        <h2 className="about-us-card-header-andrejs">Andrejs Grocs</h2>
        <p className="about-us-card-text-andrejs">Frontend/Backend</p>
        <div className="socialmedia-icons-block-andrejs">
          <a
